// http://threejs.org/examples/js/loaders/STLLoader.js
...
THREE.STLLoader.prototype.parseASCII = function (data) {
	...
	while ( ( result = patternFace.exec( data ) ) !== null ) {
		...
		// My STL files were being rendered inside-out so I inverted
		// the ordering of the faces. The original line is:
		// geometry.faces.push( new THREE.Face3( length - 3, length - 2, length - 1, normal ) );
		geometry.faces.push( new THREE.Face3( length - 1, length - 2, length - 3, normal ) );
